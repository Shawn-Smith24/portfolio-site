...
export const TimeLineData = [
  { year: 2021, text: 'Researched my options for how to become a Web Developer', },
  ...
  { year: 2023, text: 'Continuing to build projects to expand my ability and network/collaborate with peers', },
